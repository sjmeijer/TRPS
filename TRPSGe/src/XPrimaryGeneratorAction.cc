...
{ 
  ...
  // To switch back to default replace G4GeneralParticleSource with G4ParticleGun and uncomment below
  ...
  particleGun->SetParticleEnergy(10e-3*eV);  
}
...
void XPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  // To return to default, uncomment below
  particleGun->SetParticleMomentumDirection(G4RandomDirection());
