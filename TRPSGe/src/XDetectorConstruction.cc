...
void XDetectorConstruction::SetupGeometry()
{
  ...
  //                               
  // Germanium cube - this is the volume in which we will propagate phonons
  //  
  ...
  //
  // Al - crystal end caps. This is where phonon hits are registered
  //
  ...
  G4LogicalVolume* fAlLogical = new G4LogicalVolume(fAlSolid,fAl,"fAlLogical");
  ...
  //
  // detector -- Note : Al electrode sensitivity is attached to Germanium 
  //
